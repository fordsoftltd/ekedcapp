 ...
 */
@Entity
@Table(name = "poleshistory")
public class Poleshistory implements Serializable {
    ...
    @ManyToOne
    private Poles parent;

    public Poleshistory() {
    }

    public Poleshistory(Integer id) {
        this.id = id;
    }
    ...
    public Poles getParent() {
        return parent;
    }

    public void setParent(Poles parent) {
        this.parent = parent;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Poleshistory)) {
            return false;
        }
        Poleshistory other = (Poleshistory) object;
    ...
    public String toString() {
        return "com.studentmix.model.Poleshistory[ id=" + id + " ]";
    }
