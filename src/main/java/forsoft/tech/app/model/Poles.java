...
public class Poles implements Serializable {
    ...
    private List<Poleshistory> poleshistoryList;

    public Poles() {
    }

    public Poles(Integer id) {
        this.id = id;
    }
    ...
    public List<Poleshistory> getPoleshistoryList() {
        return poleshistoryList;
    }

    public void setPoleshistoryList(List<Poleshistory> poleshistoryList) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Poles)) {
            return false;
        }
        Poles other = (Poles) object;
    ...
    public String toString() {
        return "com.studentmix.model.Poles[ id=" + id + " ]";
    }
