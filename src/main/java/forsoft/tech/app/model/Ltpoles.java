...
@Entity
@Table(name = "ltpoles")
public class Ltpoles implements Serializable {
    ...
    private List<Ltpoleshistory> ltpoleshistoryList;

    public Ltpoles() {
    }

    public Ltpoles(Integer id) {
        this.id = id;
    }
    ...
    public List<Ltpoleshistory> getLtpoleshistoryList() {
        return ltpoleshistoryList;
    }

    public void setLtpoleshistoryList(List<Ltpoleshistory> ltpoleshistoryList) {
        this.ltpoleshistoryList = ltpoleshistoryList;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Ltpoles)) {
            return false;
        }
        Ltpoles other = (Ltpoles) object;
    ...
    public String toString() {
        return "com.studentmix.model.Ltpoles[ id=" + id + " ]";
    }
