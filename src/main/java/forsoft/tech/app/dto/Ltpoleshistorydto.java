...
@ManagedBean
@SessionScoped  
public class Ltpoleshistorydto implements Dto {
 private Date logindate;
    ...
    private Ltpolesdto parent;

    public Ltpoleshistorydto() {
    }

    public Ltpoleshistorydto(Integer id) {
        this.id = id;
    }
    ...
    public Ltpolesdto getParent() {
        return parent;
    }

    public void setParent(Ltpolesdto parent) {
        this.parent = parent;
    }
