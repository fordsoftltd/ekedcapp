...
@ManagedBean
@SessionScoped  
public class Ltpolesdto implements Dto {
private String contractorid;
    ...
    private String  newupriser;
    private String newltpoleno;
    
    private List<Ltpoleshistorydto> poleshistoryList;
    ...
    public String getNewupriser() {
        return newupriser;
    }

    public void setNewupriser(String newupriser) {
        this.newupriser = newupriser;
    }

    public String getNewltpoleno() {
        return newltpoleno;
    }

    public void setNewltpoleno(String newltpoleno) {
        this.newltpoleno = newltpoleno;
    }

    public Ltpolesdto() {
    }

    public Ltpolesdto(Integer id) {
        this.id = id;
    }
    ...
    public List<Ltpoleshistorydto> getPoleshistoryList() {
        return poleshistoryList;
    }

    public void setPoleshistoryList(List<Ltpoleshistorydto> poleshistoryList) {
