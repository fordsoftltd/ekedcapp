...
@ManagedBean
@SessionScoped    
public class Poleshistorydto implements Dto {
 private Date logindate;
    ...
    private Polesdto parent;

    public Poleshistorydto() {
    }

    public Poleshistorydto(Integer id) {
        this.id = id;
    }
    ...
    public Polesdto getParent() {
        return parent;
    }

    public void setParent(Polesdto parent) {
        this.parent = parent;
    }
